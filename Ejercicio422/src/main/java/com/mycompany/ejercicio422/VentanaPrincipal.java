 ...
 */
package com.mycompany.ejercicio422;
...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Numero de horas trabajadas por mes:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nombre = txtCa.getText();
        double salb = Double.parseDouble(txtCb.getText());
        double horas = Integer.parseInt(txtCc.getText());
        
        calculo calc = new calculo();
        double variable = calc.op(salb, horas);
        
        if (variable>450000){
            txtCe.setText(nombre);
            txtCf.setText(String.valueOf(variable));
        } else {

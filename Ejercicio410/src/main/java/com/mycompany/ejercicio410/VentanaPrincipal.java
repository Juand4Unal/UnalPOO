...
public class VentanaPrincipal extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtCe)
                    .addComponent(txtCf)
                    .addComponent(txtCg, javax.swing.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))
                .addGap(189, 189, 189))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int num = Integer.parseInt(txtCa.getText());
        String nombre = txtCb.getText();
        double patrimonio = Double.parseDouble(txtCc.getText());
        double estrato = Integer.parseInt(txtCd.getText());
        
        calculo calc = new calculo(patrimonio, estrato);
        String var = String.valueOf(calc.op());
        
        txtCe.setText(String.valueOf(num));
        txtCf.setText(nombre);
        txtCg.setText(var);
